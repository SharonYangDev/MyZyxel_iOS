...
+ (BOOL)checkActivateStatus:(NSString *)moduleCode
{
    ...
    else if ([moduleCode isEqualToString: @"HA_ZYXEL_S"])
    {
        display = NO;
    }
    ...
    else if ([moduleCode isEqualToString: @"CNC_ZYXEL_T"])
    {
        display = NO;
    }
    else if ([moduleCode isEqualToString: @"CNC_ZYXEL_S"])
    {
        display = NO;
    }
    else if ([moduleCode isEqualToString: @"NCC_ZYXEL_S"])
    {
        display = NO;
    }
...
{
    BOOL display = YES;
    if ([service isEqualToString: @"Content Filter_Trial"])
    {
        display = NO;
    }
    else if ([service isEqualToString: @"Anti-Virus_Trial"])
    {
        display = NO;
    }
    else if ([service isEqualToString: @"IDP_Trial"])
    {
        display = NO;
    }
    else if ([service isEqualToString: @"Anti-Spam_Trial"])
    {
        display = NO;
    }
    else if ([service isEqualToString: @"Hotspot Management Subscription Service_Trial"])
    {
        display = NO;
    }
    else if ([service isEqualToString: @"Hotspot Management One-Time Service"])
    {
        display = NO;
    }
    else if ([service isEqualToString: @"Premium Service"])
    {
        display = NO;
    }
    else if ([service isEqualToString: @"Package update (activate after register)- 3G/4G script"])
    {
        display = NO;
    }
    return display;
